-- ============================================================================
--  MODULO DFe - ROLLBACK DA EMPRESA 29 (ARQUIVO empresas/29_99)
-- ============================================================================
--  DESTRUTIVO, mas de escopo estreito: apaga o que o
--  29_01_empresa_29_dbeaver.sql criou, e nada mais. As outras empresas, a
...
--      29_99_rollback_empresa_29_dbeaver.sql   <- este
--      01_99_rollback_motor_dbeaver.sql        o motor, por ultimo
--
--  Por que nesta ordem: o certificado da empresa 29 mora em
...
--  29_01_empresa_29_dbeaver.sql criou e removido. Se alguem cadastrou a empresa 29
--  por outro caminho, a linha dele fica.
--
--  Esse filtro so passou a funcionar em 09/09/2026. Antes a empresa 29 nascia
...
select (select count(*) from poseidon.dpc_dfe_empresa
       ...
       (select count(*) from poseidon.dpc_dfe_cursor c
         ...
         where e.nro_empresa = 29)                                    as fluxos,
       (select count(*) from poseidon.dpc_conta_certif_digital_emp
         where cod_empresa = 29)                                      as certificado
  from dual;
